...
| §33–36 — degraded operation, explicit failures, resources and replay | PARTIALLY_IMPLEMENTED | B06/B12/B14/B24 provide local controls and persistent provider reservations; security states and external-effect reconciliation remain absent | Slices 5/7/9 |
