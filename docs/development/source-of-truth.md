...
**Last hosted-green implementation baseline:** `7ba585a` (M2.8 restore-to-recovery integration). Hosted [Quality run 36103438929](https://github.com/SkillSpringAI/Gnomon/actions/runs/36103438929) passed `checks`, `minimal-install`, and `browser` with 1,815 tests passed and 28 skipped.
**Current planning baseline:** `661b072f3d36de98792ee9649adce8a2db22401f` (`661b072`, M2 implementation sequence), amended with verified M2.8 progress.
**Current implementation baseline:** `7ba585a` (M2.8 governed recovery after reconstruction).
