...
|---|---|---|---|
| P1 | Backup and restore conformance | M2.1 manifest contract, M2.2 state inspection, M2.3 backup creation, M2.4 restore preflight and M2.5 database reconstruction implemented locally | Supported reconstruction fixture, state/history/provenance/audit comparison, credential non-persistence checks, recovery integration and release verification. |
...
1. Begin M2.6 Canonical Reconstruction Fixture from the incremental sequence.
2. Keep recovery-mode integration and equivalence claims deferred until the fixture and comparison helpers are reviewed and complete.
