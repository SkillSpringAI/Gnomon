...
**Last hosted-green implementation baseline:** `a75e47a` (M2.7 canonical reconstruction equivalence). Hosted [Quality run 36101721370](https://github.com/SkillSpringAI/Gnomon/actions/runs/36101721370) passed `checks`, `minimal-install`, and `browser` with 1,809 tests passed and 28 skipped.
**Current planning baseline:** `661b072f3d36de98792ee9649adce8a2db22401f` (`661b072`, M2 implementation sequence), amended with verified M2.7 progress.
**Current implementation baseline:** `a75e47a` (M2.7 canonical fixture backup/restore equivalence).
