...
|---|---|---|---|
| P1 | Backup and restore conformance | M2.1 manifest contract, M2.2 state inspection, M2.3 backup creation, M2.4 restore preflight, M2.5 database reconstruction and M2.6 canonical fixture implemented locally | State/history/provenance/audit comparison, credential non-persistence checks, recovery integration and release verification. |
...
1. Begin M2.7 Reconstruction Equivalence Verifier from the incremental sequence.
2. Keep recovery-mode integration and credential-exclusion claims deferred until equivalence helpers are reviewed and complete.
